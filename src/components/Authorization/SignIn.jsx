...
export default function SignIn() {
  ...
  return (
    <div className="p-3 max-w-lg mx-auto dark:bg-gray-900 dark:text-white">
      <h1 className="text-3xl text-center font-semibold my-7 text-slate-800 dark:text-white">
        Sign In
      </h1>
      <form
        onSubmit={handleSubmit}
        className="flex flex-col gap-4 bg-gray-200 dark:bg-gray-800 p-5 rounded-lg"
      >
        <input
          type="email"
          placeholder="Email"
